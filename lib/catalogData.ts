...
export const catalog: Product[] = [
  ...
  { id: 'drums_yamaha_sc_nat', name: 'Batería Yamaha Stage Custom', category: 'drums', subCategory: 'Kits de Batería', description: 'Color Natural. Bombo 22”, Toms 10”, 12”, Piso 16”', image: '/images/equipo2.jpeg' },
  { id: 'drums_yamaha_sc_blk', name: 'Batería Yamaha Stage Custom', category: 'drums', subCategory: 'Kits de Batería', description: 'Color Wenguen. Bombo 22”, Toms 10”, 12”, Piso 16”', image: '/images/1 (2).jpeg' },
  { id: 'drums_yamaha_sc_red', name: 'Batería Yamaha Stage Custom', category: 'drums', subCategory: 'Kits de Batería', description: 'Color Rojo. Bombo 22”, Toms 10”, 12”, Piso 16”', image: '/images/5 (13).jpeg' },
  { id: 'drums_dw_collectors', name: 'Batería DW Collectors', category: 'drums', subCategory: 'Kits de Batería', description: 'Bombo 22”, Toms 10”, 12”, Piso 16”. Sillas hidráulicas (negras, blancas)', image: '/images/5 (6).jpeg' },
  { id: 'perc_redoblante_piccolo', name: 'Redoblante Piccolo 14" Profesional', category: 'drums', subCategory: 'Redoblantes', image: '/images/equipo2.jpeg' },
  { id: 'perc_redoblante_dw', name: 'Redoblante DW', category: 'drums', subCategory: 'Redoblantes', image: '/images/equipo2.jpeg' },
  { id: 'perc_redoblante_mapex', name: 'Redoblante Mapex', category: 'drums', subCategory: 'Redoblantes', image: '/images/equipo2.jpeg' },
  { id: 'perc_platillos_zildjian', name: 'Set Platillos Zildjian A Custom', category: 'drums', subCategory: 'Platillos', description: '14” hi-hat, 10” splash, 16” crash, 18” crash, 21” ride, 18” chine', image: '/images/equipo2.jpeg' },
  ...
  { id: 'stand_pedal_dw5000', name: 'Pedal DW 5000 Doble Cadena', category: 'stands', subCategory: 'Pedales de Batería', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_pedal_dw9000', name: 'Pedal DW 9000 Doble Cadena', category: 'stands', subCategory: 'Pedales de Batería', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_hihat_dw5000', name: 'Stand Hi-Hat DW 5000', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_silla_gibraltar', name: 'Silla Gibraltar para Batería', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_platillo_gibraltar', name: 'Stand de Platillo Boom GIBRALTAR', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_redoblante_gibraltar', name: 'Base de Redoblante Gibraltar', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_mesa_percusion', name: 'Mesa de Percusión Gibraltar 7615', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_bongo_gibraltar', name: 'Stand Gibraltar para Bongos', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_djembe', name: 'Stand para Djembe', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_conga_sencillo', name: 'Stand Conga Individual LP 636', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_conga_doble', name: 'Stand Conga Doble LP 290B', category: 'stands', subCategory: 'Herrajes y Soportes', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_guitarra_hercules', name: 'Stand de Guitarra HÉRCULES 415BPLUS', category: 'stands', subCategory: 'Soportes de Instrumento', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_piano_sencillo', name: 'Stand Sencillo para Piano HÉRCULES (Doble X)', category: 'stands', subCategory: 'Soportes de Teclado', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_piano_doble', name: 'Stand Doble para Piano Hércules', category: 'stands', subCategory: 'Soportes de Teclado', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_tablet_hercules', name: 'Stand de Tablet Hércules', category: 'stands', subCategory: 'Accesorios Adicionales', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_ipad', name: 'Stand de iPad', category: 'stands', subCategory: 'Accesorios Adicionales', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_partitura', name: 'Atril de Partituras con Luz', category: 'stands', subCategory: 'Accesorios Adicionales', image: '/images/stand_placeholder.jpg' },
  { id: 'stand_plexiglass', name: 'Plexiglass con Cobertura 180°', category: 'stands', subCategory: 'Accesorios Adicionales', image: '/images/stand_placeholder.jpg' },
];